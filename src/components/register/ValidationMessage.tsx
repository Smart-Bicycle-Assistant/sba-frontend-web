...
const ValidationMessage: React.FC<ValidationProps> = ({ value, type, passwordCheck }) => {
  const [validationMessage, setValidationMessage] = useState<ValidationMessage>('initial');
