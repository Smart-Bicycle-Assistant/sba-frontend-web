      ...
      <div className="flex flex-col items-center p-6">
        <div className="border rounded-md p-4  w-[96%] shadow-sm">
          <div className="flex items-center mb-2">
            <img src={bicycle} alt="자전거 이미지" className="w-12 h-12 bg-gray-100 rounded-full" />
            <div className="ml-3">
              <p className="mb-1 text-lg font-semibold text-gray-700">자전거 1</p>
            </div>
          </div>

          <hr className="my-4" />
          <div className="relative h-60">
            <img src={bicycle} alt="자전거 이미지" className="w-40 pt-12 mx-auto h-44" />
          ...
          <div className="flex justify-center mx-1 my-3 rounded-md">
            <button
              className="px-6 py-2 m-2 text-sm font-normal text-white rounded-md shadow-sm bg-primary-default"
              onClick={() => {
