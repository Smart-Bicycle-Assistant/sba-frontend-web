      ...
      <div className="content_fixed">
        ...
        <div className="flex flex-col content gap-y-8">
          ...
          <div className="flex flex-col gap-y-3">
            <div>
              <div className="py-2 text-sm text-slate-400">자전거 관리</div>
              <Link to="/bicycle">
            ...
            <div>
              <div className="py-2 text-sm text-slate-400">고객센터</div>
              <Link to="/report">
                <div className="flex items-center py-2.5 text-sm gap-x-2 rounded-xl">
                  <span className="material-symbols-outlined text-slate-400">
                    account_circle
                  </span>
                  <p className="text-base">내가 신고한 유저</p>
                </div>
              </Link>
              <Link to="/error">
                <div className="flex items-center py-2.5 text-sm gap-x-2 rounded-xl">
            ...
            <div>
              <div className="py-2 text-sm text-slate-400">내 정보 관리</div>
